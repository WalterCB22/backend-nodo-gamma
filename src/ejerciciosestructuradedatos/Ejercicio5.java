...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        System.out.println("Escriba un numero entero n para mostrar los n primeros numeros naturales que contengan n digitos d: ");
        int n = scanner.nextInt();

        System.out.println("ingrese un numero entero m: ");
